...
class Archer(Character):
    ...
    """
    def __init__(self, model, name='Archer', level=1, HP=6,strength=4,defense=1,agility=3,intelligence=3,movement=5, xpToNextLevel=100, weapontype=item.Bow(), location=(2*ref,3*ref), dodge = 5 , crit=5, team=1, can_move = False):
...
class Warrior(Character):
    ...
    """
    def __init__(self, model, name='Warrior', level=1, HP=9,strength=5,defense=2,agility=1,intelligence=1,movement=5, xpToNextLevel=100, weapontype=item.Sword(), location=(2*ref,3*ref), dodge = 5 , crit=5, team=1, can_move = False):
        Character.__init__(self,model, name,level, HP,strength,defense,agility,intelligence,movement, xpToNextLevel,weapontype,location, dodge, crit, team)
...
class Horseman(Character):
    ...
    """
    def __init__(self, x,y, name='Horsemen', level=1, HP=8,strength=3,defense=3,agility=2,intelligence=2,movement=5, xpToNextLevel=100, weapontype=item.Lance(), location=(2*ref,3*ref), dodge = 5 , crit=5, team=1, can_move = False):
        Character.__init__(self,model, name,level, HP,strength,defense,agility,intelligence,movement, xpToNextLevel,weapontype,location, dodge, crit, team)
